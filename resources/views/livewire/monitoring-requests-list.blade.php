                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition cursor-pointer">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">{{ __('app.target_date') }}: {{ $request->target_date->format('Y-m-d') }}</p>
                                @if($request->email)
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs text-gray-400 mt-1">{{ __('app.created') }} {{ $request->created_at->diffForHumans() }}</p>
                            </div>
                        </div>
                    </div>
                </a>
